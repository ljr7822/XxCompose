 ...
 * @Package: com.example.xxcompose.utlis
 */
object XxEasyDataStore {

    // 创建DataStore
    private val XxApplication.dataStore: DataStore<Preferences> by preferencesDataStore(name = "GoodNews")

    // DataStore变量
    private val dataStore = XxApplication.instance.dataStore
